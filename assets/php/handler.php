...
$mail_to_email = 'han.nim@hewani.cloud'; //My email
$mail_to_name = 'Han Nim';
...
try {
	...
	$mail->Host = 'mail45.lwspanel.com'; // Set the SMTP server to send through
	$mail->SMTPAuth = true; // Enable SMTP authentication
	$mail->Username = 'han.nim@shortway-info.net'; // SMTP username
$mail->Password = 'Hansikims@145'; // SMTP password
